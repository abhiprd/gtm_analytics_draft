...
- Facts: `fact_engagement`, `fact_outbound_activity`, `fact_sales_activities`, `fact_opportunities`, `fact_opportunity_stage_history`, `fact_usage_monthly`, `fact_revenue_monthly`, `fact_account_segment_history`, `fact_workflow_chain_events`, `fact_content_engagement`, `fact_community_membership`, `fact_support_tickets`, `fact_am_activity`, `fact_marketing_spend`, `fact_forecast_submissions`, `fact_lead_scoring_history`, `fact_playbook_triggers`
