...
**Reporting period:** November 1 - November 30, 2025 (monthly grain)
...
|---|---|---|---|---|
| New logo consumption revenue | $45.2K | $19.8K plan | +128.2% | Ahead |
| Activation (TTFA, blended) | 0.00 mo | 0.00 mo last month | n/a | Not computable |
| Expansion consumption revenue | $760.6K | $173.8K plan | +337.6% | Ahead |
| Contraction + churned revenue | $502.4K | $49.3K plan | +919.1% | Behind |

### Layer 1 - Efficiency

| Metric | Value | vs. plan | Variance | Status |
|---|---|---|---|---|
| Magic number (blended) | n/a | 0.77x plan (no computable actual) | n/a | Not computable |
| Consumption payback (blended) | 0.06 mo | 11.99 mo plan | -99.5% | Ahead |
| Onboarding/CS efficiency (blended) | 4.22e-06 touches/Action | 6.03e-06 touches/Action plan | -30.0% | Ahead |
| AM efficiency (blended) | n/a | 2.88x plan (no computable actual) | n/a | Not computable |

### Layer 1 - Durability

| Metric | Value | vs. plan | Variance | Status |
|---|---|---|---|---|
| NRR | 181.8% | 117.1% plan | +55.2% | Ahead |
| GRR | 51.3% | 92.7% plan | -44.7% | Behind |
| Logo retention | 84.9% | 84.0% plan | +1.1% | On track |
...
### 1. New logo consumption revenue - $45.2K vs. $19.8K plan (+128.2%, plan_diff)

- **Layer 2 coverage:** 2 of 3 children of this node have a mart-computable actual.
- **Layer 2 outlier:** Avg initial commitment (layer 2, child of `new_logo_consumption_revenue`) - 1.22e+05 this period vs. a 6.053e+04 trailing baseline (+101.5%), ranked by `relative_deviation`; computability: computable.

| Rank | Layer-2 sibling | Layer | Value | Trailing baseline | Deviation | Computability |
|---|---|---|---|---|---|---|
| 1 | Avg initial commitment | 2 | 1.22e+05 | 6.053e+04 | +101.5% | computable |
...
- _Note:_ avg_initial_commitment does have Layer-3 children in the tree, but none is computable from any mart_* table; see layer3_evidence's missing list for the reasons.
...
- **Layer 2 outlier:** Cyclical/planned usage dip vs. structural churn (layer 2, child of `contraction_churned_revenue`) - 0.01194 this period vs. a 0.02769 trailing baseline (-56.9%), ranked by `relative_deviation`; computability: partial.
...
### 4. Consumption payback (blended) - 0.06 mo vs. 11.99 mo plan (-99.5%, plan_diff)

- **Layer 2 coverage:** 2 of 2 children of this node have a mart-computable actual.
- **Layer 2 outlier:** CAC by channel (unblended) (layer 2, child of `consumption_payback`) - 400.4 this period vs. a 868 trailing baseline (-53.9%), ranked by `relative_deviation`; computability: partial.

| Rank | Layer-2 sibling | Layer | Value | Trailing baseline | Deviation | Computability |
|---|---|---|---|---|---|---|
| 1 | CAC by channel (unblended) | 2 | 400.4 | 868 | -53.9% | partial |
| 2 | Utilized vs. committed Action volume | 2 | 2.334e+04 | 2.261e+04 | +3.3% | partial |
...
### 5. Onboarding/CS efficiency (blended) - 4.22e-06 touches/Action vs. 6.03e-06 touches/Action plan (-30.0%, plan_diff)

- **Layer 2 coverage:** 2 of 2 children of this node have a mart-computable actual.
- **Layer 2 outlier:** Automated Action volume delivered (layer 2, child of `onboarding_cs_efficiency`) - 1.965e+08 this period vs. a 1.467e+08 trailing baseline (+33.9%), ranked by `relative_deviation`; computability: computable.

| Rank | Layer-2 sibling | Layer | Value | Trailing baseline | Deviation | Computability |
|---|---|---|---|---|---|---|
| 1 | Automated Action volume delivered | 2 | 1.965e+08 | 1.467e+08 | +33.9% | computable |
| 2 | AM touchpoint volume | 2 | 829 | 743.6 | +11.5% | computable |
...
### 6. NRR - 181.8% vs. 117.1% plan (+55.2%, plan_diff)

- **Layer 2 coverage:** 3 of 3 children of this node have a mart-computable actual.
- **Layer 2 outlier:** Expansion (share of starting revenue) (layer 2, child of `nrr`) - 0.07897 this period vs. a 0.1034 trailing baseline (-23.6%), ranked by `additive_share`; computability: computable.
  - This node is the tree's cross-reference to `expansion_consumption_revenue` under Growth, not an independent driver.

| Rank | Layer-2 sibling | Layer | Value | Trailing baseline | Deviation | Computability |
|---|---|---|---|---|---|---|
| 1 | Expansion (share of starting revenue) | 2 | 0.07897 | 0.1034 | -23.6% | computable |
| 2 | Contraction (share of starting revenue) | 2 | 0.05119 | 0.04521 | +13.2% | computable |
| 3 | Churn (share of starting revenue) | 2 | 0.0009804 | 0.001489 | -34.2% | computable |
...
### 7. GRR - 51.3% vs. 92.7% plan (-44.7%, plan_diff)

- **Layer 2 coverage:** 2 of 2 children of this node have a mart-computable actual.
- **Layer 2 outlier:** Contraction (share of starting revenue) (layer 2, child of `grr`) - 0.05119 this period vs. a 0.04521 trailing baseline (+13.2%), ranked by `additive_share`; computability: computable.
  - This node is the tree's cross-reference to `contraction_churned_revenue` under Growth, not an independent driver.

| Rank | Layer-2 sibling | Layer | Value | Trailing baseline | Deviation | Computability |
|---|---|---|---|---|---|---|
| 1 | Contraction (share of starting revenue) | 2 | 0.05119 | 0.04521 | +13.2% | computable |
| 2 | Churn (share of starting revenue) | 2 | 0.0009804 | 0.001489 | -34.2% | computable |
...
|---|---|---|---|---|---|---|
| 1 | ACC-000254 | Commercial | High | 0.914 | 8.6 | $26.7K |
| 2 | ACC-000382 | Commercial | High | 0.910 | 9.0 | $26.7K |
| 3 | ACC-000243 | Commercial | High | 0.898 | 10.2 | $26.7K |
| 4 | ACC-000253 | Commercial | High | 0.896 | 10.4 | $26.7K |
| 5 | ACC-000429 | Commercial | High | 0.888 | 11.2 | $26.7K |
| 6 | ACC-000320 | Commercial | High | 0.887 | 11.3 | $26.7K |
| 7 | ACC-000203 | Commercial | High | 0.869 | 13.1 | $26.7K |
| 8 | ACC-000164 | Commercial | High | 0.864 | 13.6 | $26.7K |
| 9 | ACC-000208 | Commercial | High | 0.853 | 14.7 | $26.7K |
| 10 | ACC-000959 | Commercial | High | 0.838 | 16.2 | $26.7K |
| 11 | ACC-000220 | Commercial | High | 0.831 | 16.9 | $26.7K |
| 12 | ACC-006843 | Commercial | High | 0.824 | 17.6 | $26.7K |
| 13 | ACC-005731 | Commercial | High | 0.820 | 18.0 | $26.7K |
| 14 | ACC-000252 | Commercial | High | 0.800 | 20.0 | $26.7K |
| 15 | ACC-000221 | Commercial | High | 0.789 | 21.1 | $26.7K |
| 16 | ACC-002676 | Commercial | High | 0.788 | 21.2 | $26.7K |
| 17 | ACC-000292 | Commercial | High | 0.783 | 21.7 | $26.7K |
| 18 | ACC-000206 | Commercial | High | 0.779 | 22.1 | $26.7K |
| 19 | ACC-000322 | Commercial | High | 0.767 | 23.3 | $26.7K |
| 20 | ACC-000455 | Commercial | High | 0.767 | 23.3 | $26.7K |
| 21 | ACC-000449 | Commercial | High | 0.767 | 23.3 | $26.7K |
| 22 | ACC-000318 | Commercial | High | 0.766 | 23.4 | $26.7K |
| 23 | ACC-006364 | Commercial | High | 0.766 | 23.4 | $26.7K |
| 24 | ACC-000309 | Commercial | High | 0.762 | 23.8 | $26.7K |
| 25 | ACC-000271 | Commercial | High | 0.762 | 23.8 | $26.7K |
